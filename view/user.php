<div class="container text-center">
	<form id='register' action = "index.php?action=user" method = "POST" role="form">
					<div class="form-group col-sm-3">
						...
						<input type='text' name='name' id='name' maxlength="50" class="form-control" value="<?= $_SESSION['name']?>">
					</div>
					<div class="form-group col-sm-7">
						<label for='name' >Повне ім'я: </label>
						<input type='text' name='name_full' id='name_full' maxlength="50" class="form-control" value="<?= $_SESSION['f_name']?>">
					</div>
					<div class="form-group col-sm-10">
						<label for='email' >Електронна адреса:</label>
						<input type='text' name='email' id='email'  maxlength="50" class="form-control" value="<?= $_SESSION['email']?>">
					</div>
					<div class="form-group col-sm-10">
						<label for='sex' >Стать:</label><br>
						<?php if($_SESSION['sex']==0)
						echo "<input type = 'radio' name = 'gender' value = 'woman' checked = 'checked'> Жін. <input type = 'radio' name = 'gender' value = 'man' > Чол.";
						else
						echo "<input type = 'radio' name = 'gender' value = 'woman' > Жін. <input type = 'radio' name = 'gender' value = 'man' checked = 'checked'> Чол.";
						?>
					</div>
					<div class="form-group col-sm-10">
